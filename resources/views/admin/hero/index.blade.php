        ...
        <form method="POST" action="{{ route('admin.hero.update') }}" enctype="multipart/form-data">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px;">
                <div class="form-group">
                    ...
                    <input type="text" name="hero_subtitle" class="form-control" value="{{ $settings['hero']->where('key', 'hero_subtitle')->first()->value ?? '' }}">
                </div>
                
                <div class="form-group">
                    <label class="form-label">Main Title</label>
                    <input type="text" name="hero_title" class="form-control" value="{{ $settings['hero']->where('key', 'hero_title')->first()->value ?? '' }}">
                </div>

                <div class="form-group">
                    <label class="form-label">Location</label>
                    <input type="text" name="hero_location" class="form-control" value="{{ $settings['hero']->where('key', 'hero_location')->first()->value ?? '' }}">
                </div>

                <div class="form-group">
                    <label class="form-label">Dates</label>
                    <input type="text" name="hero_dates" class="form-control" value="{{ $settings['hero']->where('key', 'hero_dates')->first()->value ?? '' }}">
                </div>

                <div class="form-group">
                    <label class="form-label">Button Text</label>
                    <input type="text" name="hero_btn1_text" class="form-control" value="{{ $settings['hero']->where('key', 'hero_btn1_text')->first()->value ?? '' }}">
                </div>
