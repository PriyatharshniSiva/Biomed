        ...
        <div id="schedule-content-tracks" class="schedule-tab-panel" style="display: none;">
            <div style="border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; background: #ffffff; padding: 30px; box-shadow: 0 4px 20px rgba(0,0,0,0.03);">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
                    <div style="background: #f8fafc; border-left: 4px solid #009688; border-radius: 8px; padding: 20px;">
                        <h4 style="color: #009688; margin: 0 0 8px 0; font-weight: 700;">Track I</h4>
                        <p style="margin: 0; color: #1e293b; font-weight: 600;">Diagnostic Microbiology & Antimicrobial Resistance</p>
                    </div>
                    <div style="background: #f8fafc; border-left: 4px solid #6366f1; border-radius: 8px; padding: 20px;">
                        <h4 style="color: #6366f1; margin: 0 0 8px 0; font-weight: 700;">Track II</h4>
                        <p style="margin: 0; color: #1e293b; font-weight: 600;">Translational Chemistry & Bio-Therapeutics</p>
                    </div>
                    <div style="background: #f8fafc; border-left: 4px solid #00a896; border-radius: 8px; padding: 20px;">
                        <h4 style="color: #00a896; margin: 0 0 8px 0; font-weight: 700;">Track III</h4>
                        <p style="margin: 0; color: #1e293b; font-weight: 600;">Nanotechnology & Point-of-Care Bio-Diagnostics</p>
                    </div>
                    <div style="background: #f8fafc; border-left: 4px solid #8bc34a; border-radius: 8px; padding: 20px;">
                        <h4 style="color: #8bc34a; margin: 0 0 8px 0; font-weight: 700;">Track IV</h4>
                        <p style="margin: 0; color: #1e293b; font-weight: 600;">AI & Digital Health Diagnostics in One Health</p>
                    </div>
